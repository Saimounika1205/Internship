...
products = [
    ...
    {'id': 5, 'name': 'Books',          'price':  999, 'category': 'Stationery',  'in_stock': True },
    {'id': 6, 'name': 'Keyboard',          'price':  199, 'category': 'Electronics',  'in_stock': False },
    {'id': 7, 'name': 'Charts',          'price':  49, 'category': 'Stationery',  'in_stock': False }
]
